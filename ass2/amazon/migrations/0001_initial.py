# Generated by Django 2.2.7 on 2019-12-01 04:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_id', models.OneToOneField(default=0, on_delete=django.db.models.deletion.CASCADE, to='amazon.Payment')),
                ('shipping_id', models.OneToOneField(default=0, on_delete=django.db.models.deletion.CASCADE, to='amazon.Shipment')),
            ],
            options={
                'db_table': 'Order',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='amazon.Seller')),
            ],
            options={
                'db_table': 'Product',
            },
